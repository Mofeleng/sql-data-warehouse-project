...
-- Purpose: Loads data from the bronze layer into the silver layer tables
-- Description:
--   1. Truncates existing data in silver tables.
--   2. Inserts transformed data from the bronze layer into silver layer tables:
--      - crm_cust_info
--      - crm_prd_info
--      - crm_sales_details
--      - erp_cust_az12
--      - erp_loc_a101
--      - erp_px_cat_g1v2
--   3. Measures and prints the duration of each load process and the total load duration.
-- Error Handling: Catches and prints any errors during the load process.
